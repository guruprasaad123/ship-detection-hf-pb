...
def get_submission_transform():
	"""
	Define the submission transforms
	"""
	return A.Compose([
		ToTensorV2(p=1.0),
	])
...
def get_model_by_name(model_name):
	...
	if model_name == 'fasterrcnn_resnet18':
	...
	elif model_name == 'fasterrcnn_mobilenetv3_large_320_fpn':
	...
	elif model_name == 'fasterrcnn_squeezenet1_0':

		from models.fasterrcnn_squeezenet1_0 import create_model

		return create_model

	elif model_name == 'fasterrcnn_squeezenet1_1':
